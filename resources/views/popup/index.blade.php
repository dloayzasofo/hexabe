...
@section('main')
    <div class="row sm-vl-base mb-4">
        <div class="col-sm-8 col-md-6">
            <h4 class="fw-bold">
                <span class="text-muted fw-light">Popups
            </h4>
        </div>
        <div class="col-sm-4 col-md-6">
            <div class="dt-action-buttons text-end pt-md-0">
                <div class="dt-buttons"> 
                    <a href="{{route('popup.create')}}" class="dt-button create-new btn btn-primary">
    ...
    @if(Session::has('popup.delete'))
    <div class="alert alert-success alert-dismissible" role="alert">
        {{ Session::get('popup.delete') }}
...
<script>
    ...
    $(document).ready(function(){
        ...
        $(document).on('click', '.popupActionToggle', popupActionToggle);
    });

    function popupActionToggle(){
