                    ...
                    <tr>
                        <td>
                            ...
                            >
                                ...
                                <tr>
                                    <td align="center">
                                        <img src="{{ env('APP_URL') }}/assets/img/logo.png" width="150" height="42" style="width:150px;height:42px;" />
                                    </td>
                                </tr>
                                <tr>
                                    <td style="height: 10px;">&nbsp;</td>
                                ...
                                <tr>
                                    <td width="300" style="font-size:18px;font-weight:bold;text-align:center;color:#434343;font-family:Arial,Helvetica,sans-serif;line-height:20px;padding-right:15px;">
                                        {{ $notification->title }}
                                    </td>
                                </tr>
                                <tr>
                                        ...
                                        >
                                            <tr>
                                                <td style="text-align:justify;font-weight:normal;color:#434343;font-family:Arial,Helvetica,sans-serif;">
                                                    <h3 style="text-decoration:none;margin-bottom:10px;font-weight: bold;font-size: 18px;"> Mensaje: </h3>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td>
                                                    <a href="{{ $notification->link }}" style="display:inline-block;padding:10px 20px; background-color: #007BFF; color: #FFFFFF; text-decoration:none; border-radius:5px;font-family:Arial,Helvetica,sans-serif;font-size:14px;">
                                                        Ver Tarea
                                                    </a>
                                                </td>
                                            </tr>
