...
function setActiveToMenuByUrl(){
    var menu = {
        //'admin': "menu-admin",
        'memory': "menu-memory",
        'requisitos': "menu-requisitos",
        'financial': "menu-financial",
        'award': "menu-award",
        'team': "menu-team",
        'tarifario': "menu-tarifario",
        'requisito': "menu-fondo-requisitos",
        'popup': "menu-popup",
        'gestion': "menu-gestion",
        'bono': "menu-bono",
        ...
        'user': "menu-user",
        'pagare': "menu-pagare",
        'postulation': "menu-forms-postulations",
        'cv': "menu-forms-cv",
